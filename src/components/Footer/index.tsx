...
export default function Footer({ className }: { className?: string }) {
    ...
    return (
        <footer className={cn(
            style.footer,
            className,
            "h-[4%] min-h-[160px] w-full text-white bg-[#202020] shadow-2xl shadow-black",
            ...
            <div className="wrapper flex flex-col w-full h-full justify-center items-center gap-5">
                <section className="w-full h-full flex justify-between items-center flex-col md:flex-row">
