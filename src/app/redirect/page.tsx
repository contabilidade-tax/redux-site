...
import { useInstaPostsContext, InstaPostsContextProvider } from '@/common/context/InstagramPostsContext';
...
function Core() {
    ...
    useEffect(() => {
        ...
        updateState().then(() => {
            ...
            router.push('/home?welcome=1&noRefresh=1');
        });
    }, [updateState, router]);
    ...
    return (
        <section className='w-full h-full flex justify-center relative my-auto items-center flex-col'>
