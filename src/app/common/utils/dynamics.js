...
;(function () {
  ...
  let DecomposedMatrix2D
  let InterpolableArray
  let InterpolableColor
  let InterpolableNumber
  let InterpolableObject
  let InterpolableString
  let Matrix
  let Matrix2D
  let Set
  let Vector
  let addTimeout
  let addUnitsToNumberInterpolables
  let animationTick
  let animations
  ...
  let cancelTimeout
  let clone
  let createInterpolable
  let defaultValueForKey
  let degProperties
  let dynamics
  let getCurrentProperties
  let interpolate
  let isDocumentVisible
  let isSVGElement
  let lastTime
  let leftDelayForTimeout
  let makeArrayFn
  let observeVisibilityChange
  let parseProperties
  let prefixFor
  ...
  let startRunLoop
  let svgProperties
  let timeBeforeVisibilityChange
  let timeoutLastId
  let timeouts
  let toDashed
  let transformProperties
  let transformValueForProperty
  let unitForProperty
  ...
  applyProperties = function (el, properties) {
    let isSVG, k, matrix, transforms, v
  ...
  parseProperties = function (properties) {
    let axis, match, parsed, property, value, _i, _len, _ref
    parsed = {}
  ...
  getCurrentProperties = function (el, keys) {
    let isSVG, key, matrix, properties, style, v, _i, _j, _len, _len1, _ref
    properties = {}
    isSVG = isSVGElement(el)
    if (el.style != null) {
  ...
  createInterpolable = function (value) {
    let interpolable, klass, klasses, _i, _len
    klasses = [
      InterpolableArray,
      InterpolableObject,
      InterpolableNumber,
  ...
  InterpolableString = (function () {
    ...
    InterpolableString.prototype.interpolate = function (endInterpolable, t) {
      let end, i, newParts, start, _i, _ref
      start = this.parts
    ...
    InterpolableString.create = function (value) {
      let index, match, matches, parts, re, type, types, _i, _j, _len, _len1
      value = '' + value
      matches = []
      types = [
        {
  ...
  InterpolableArray = (function () {
    ...
    InterpolableArray.prototype.interpolate = function (endInterpolable, t) {
      let end, i, newValues, start, _i, _ref
      start = this.values
  ...
  InterpolableColor = (function () {
    ...
    InterpolableColor.prototype.interpolate = function (endInterpolable, t) {
      let end, k, rgb, start, v, _i, _len, _ref
      start = this.color
  ...
  DecomposedMatrix2D = (function () {
    ...
    DecomposedMatrix2D.prototype.interpolate = function (endMatrix, t) {
      let i, k, newProps, _i, _j, _k, _l, _len, _len1, _ref, _ref1, _ref2
      newProps = {}
    ...
    DecomposedMatrix2D.prototype.applyRotateCenter = function (rotateC) {
      let i, m, m2d, negativeTranslate, _i, _results
  ...
  Matrix2D = (function () {
    ...
    Matrix2D.prototype.applyProperties = function (properties) {
      let hash, k, props, v, _i, _len, _ref, _ref1
      hash = {}
  ...
  Vector = (function () {
    ...
    Vector.prototype.normalize = function () {
      let e, i, length, newElements, _ref
      length = this.length()
      newElements = []
      _ref = this.els
      for (i in _ref) {
  ...
  Matrix = (function () {
    ...
    Matrix.prototype.multiply = function (matrix) {
      let M, c, cols, elements, i, j, ki, kj, nc, ni, nj, returnVector, sum
    ...
    Matrix.prototype.transpose = function () {
      let cols, elements, i, j, ni, nj, rows
    ...
    Matrix.prototype.toRightTriangular = function () {
      let M, els, i, j, k, kp, multiplier, n, np, p, _i, _j, _ref, _ref1
      M = this.dup()
      n = this.els.length
      k = n
    ...
    Matrix.matrixForTransform = cacheFn(function (transform) {
      let matrixEl, result, style, _ref, _ref1, _ref2
    ...
    Matrix.fromTransform = function (transform) {
      let digits, elements, i, match, matrixElements, _i
      match =
        transform != null
  ...
  prefixFor = cacheFn(function (property) {
    let k, prefix, prop, propArray, propertyName, _i, _j, _len, _len1, _ref
  ...
  runLoopTick = function (t) {
    let animation, toRemoveAnimations, _i, _len
    if (runLoopPaused) {
      rAF(runLoopTick)
      return
    }
  ...
  animationTick = function (t, animation) {
    let key, properties, property, tt, y, _base, _base1, _ref
  ...
  startAnimation = function (el, properties, options, timeoutId) {
    let endProperties, isSVG, k, matrix, startProperties, transforms, v
    if (timeoutId != null) {
  ...
  observeVisibilityChange(function (visible) {
    let animation, difference, timeout, _i, _j, _k, _len, _len1, _len2, _results
  ...
  dynamics.spring = function (options) {
    let A1, A2, decal, frequency, friction, s
    if (options == null) {
      options = {}
    }
  ...
  dynamics.gravity = function (options) {
    let L, bounciness, curves, elasticity, fn, getPointInCurve, gravity
    if (options == null) {
      options = {}
    }
  ...
  dynamics.bezier = (function () {
    ...
    yForX = function (xTarget, Bs, returnsToSelf) {
      let B, aB, i, lower, percent, upper, x, xTolerance, _i, _len
      B = null
